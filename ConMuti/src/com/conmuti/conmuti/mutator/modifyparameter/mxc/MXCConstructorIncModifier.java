...
/**
 * A class which increments the initial values of barriers, latches and semaphores in a compilation unit
 */
public class MXCConstructorIncModifier extends MutationModifier {
    /**
     ...
     * its initial value is incremented
     * <p>
