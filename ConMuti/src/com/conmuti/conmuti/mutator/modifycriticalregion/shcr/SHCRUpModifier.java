...
/**
 * A class to shift the critical region of synchronized statements upwards by one statement
 */
public class SHCRUpModifier extends MutationModifier {
    /**
     ...
     * the scope of the synchronicity is moved one step upwards.
