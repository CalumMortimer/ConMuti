 ...
 */
public class RXOBarrierModifier extends MutationModifier {
     ...
     * to barriers. The visit method of this class is used as an adapter to the visit method
    ...
    public CompilationUnit visit(CompilationUnit cu, Void arg) {
        ...
        MutationModifier modifier = new RXOGenericModifier(typeList);
