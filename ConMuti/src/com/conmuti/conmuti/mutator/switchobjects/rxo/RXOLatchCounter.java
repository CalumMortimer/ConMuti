...
/**
 * A class which walks calls on the RXOGenericCounter class with a set of object types relating to latches
 */
public class RXOLatchCounter extends MutationCounter {
     ...
     * relating to latches. The visit method of this class is an adapter to the visit method
