...
/**
 * A class which walks calls on the RXOGenericCounter class with a set of object types relating to semaphores
 */
public class RXOSemaphoreCounter extends MutationCounter {
     ...
     * relating to semaphores. The visit method of this class is an adapter to the visit method
