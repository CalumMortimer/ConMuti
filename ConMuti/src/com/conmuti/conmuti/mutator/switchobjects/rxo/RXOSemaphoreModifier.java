 ...
 * relating to semaphores
 */
public class RXOSemaphoreModifier extends MutationModifier {
     ...
     * to semaphores. The visit method of this class is used as an adapter to the visit method
